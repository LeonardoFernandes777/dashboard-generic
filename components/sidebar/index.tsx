...
import { PanelBottom, Package, Home, ShoppingBag, Users, Settings2, LogOutIcon } from "lucide-react";
...
export function Sidebar() {
  return (
    <div className="flex w-full flex-col bg-muted/40">
        ...
        <aside className="fixed inset-y-0 left-0 z-10 hidden w-16 border-r bg-background sm:flex">
            ...
            <header 
             ...
             >
                <Sheet>
                    ...
                    <SheetContent side="left" className="sm:max-w-x p-4"> 
                        <nav className="grid gap-6 text-lg font-medium">
                            <Link 
                                ...
                                >
                                <Package className="h-5 w-5 transition-all" />
                                <SheetTitle className="sr-only">Logo do projeto</SheetTitle>
                            </Link>
